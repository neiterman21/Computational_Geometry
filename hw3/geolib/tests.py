...
from hw3.geolib.DataPreprocessing import numbers2points
from hw3.geolib.FunctionaHelpers import point_on_line, compute_big_rectangle
...
def test_compute_route():
    ...
    from hw3.geolib.DataPreprocessing import plot_state
